...
func (s *Server) setupRoutes() {
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/api/conversations/{id}/read", s.handleMarkConversationRead)
		r.Post("/api/conversations/{id}/unread", s.handleMarkConversationUnread)
		...
		r.Post("/api/conversations/{id}/fork-message", s.handleForkConversationFromMessage)
		r.Get("/api/conversations/{id}/tree", s.handleGetConversationTree)
		r.Post("/api/conversations/{id}/tree/select", s.handleSelectConversationTreeLeaf)
		r.Post("/api/conversations/{id}/tree/edit", s.handleEditConversationTreeMessage)
		...
		r.Get("/api/conversations/{id}/models", s.handleListConversationModels)
		r.Post("/api/conversations/{id}/model", s.handleSetConversationModel)
		r.Post("/api/conversations/{id}/thinking", s.handleSetConversationThinking)
		r.Post("/api/conversations/{id}/auto-compaction", s.handleSetConversationAutoCompaction)
		r.Post("/api/conversations/{id}/compact", s.handleCompactConversation)
		r.Get("/api/conversations/{id}/session", s.handleGetConversationSessionStats)
		...
		r.Post("/api/skills/catalog/sources", s.handleCreateSkillCatalogSource)
		r.Delete("/api/skills/catalog/sources/{sourceId}", s.handleDeleteSkillCatalogSource)
		r.Post("/api/skills/catalog/refresh", s.handleRefreshSkillCatalog)
		r.Get("/api/skills/catalog", s.handleListSkillCatalog)
		r.Post("/api/skills/catalog", s.handleInstallGlobalCatalogSkill)
		r.Delete("/api/skills/{target}/{name}", s.handleDeleteGlobalSkill)
		...
		r.Post("/api/workspaces/{id}/git/rebase", s.handleWorkspaceGitRebase)
		r.Post("/api/workspaces/{id}/git/operation/continue", s.handleWorkspaceGitOperationContinue)
		r.Post("/api/workspaces/{id}/git/operation/abort", s.handleWorkspaceGitOperationAbort)
		r.Get("/api/workspaces/{id}/git/conflict-context", s.handleWorkspaceGitConflictContext)
		r.Post("/api/workspaces/{id}/git/stash", s.handleWorkspaceGitStash)
		r.Get("/api/workspaces/{id}/git/log", s.handleWorkspaceGitLog)
		r.Get("/api/workspaces/{id}/pull-request", s.handleWorkspacePullRequest)
		r.Post("/api/workspaces/{id}/pull-request", s.handleCreateWorkspacePullRequest)
