...
echo ""
echo "4. Configure the origin for CORS, passkeys, and Telegram login:"
echo "   ssh codeburg-server"
echo "   cat >> ~/.codeburg/config.yaml << 'EOF'"
echo "     origin: \"https://codeburg.miscellanics.com\""
echo "   EOF"
echo "   sudo systemctl restart codeburg"
echo ""
echo "5. On your dev machine, add to ~/.ssh/config:"
