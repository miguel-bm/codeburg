...
import { AlertCircle, Archive, CheckCircle2, Fingerprint, KeyRound, Trash2, Pencil, Volume2, Bell, Terminal, Code2, Lock, Send, Keyboard, LogOut, SunMoon, Sun, Moon, Monitor, X } from 'lucide-react';
import { useSetHeader, HeaderProvider, Header } from '../components/layout/Header';
import { authApi, preferencesApi, projectsApi } from '../api';
        ...
        {isLoading ? (
          ...
          <div className="space-y-0">
            {archives.map((archive: ArchiveInfo) => (
              <div key={archive.filename} className="flex items-center justify-between gap-3 py-3 border-b border-subtle last:border-b-0">
                <div className="min-w-0 flex-1">
